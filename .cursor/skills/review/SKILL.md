...
security before approving a change. Focus on architecture, readability, maintainability,
performance implications, and provide actionable suggestions for improvement.

## Steps

1. **Understand the change**
   - Check if the branch name contains the JIRA issue number (format: ABCDEF-1234) and look
     up the JIRA issue via the Atlassion MCP for the requirements and acceptance criteria
   - Check the changes of the current branch compared to master
